...
from conf.confs import url_assetPage, asset_test_data, Host2, account_LZJ_003, password_LZJ_003
...
def login_init(browser: Browser):
    ...
    if os.path.exists(cookie_file):
        ...
        login.login(Host2, account_LZJ_003, password_LZJ_003)
        time.sleep(2)
    yield page
    try:
        # 保存登录验证cookie
